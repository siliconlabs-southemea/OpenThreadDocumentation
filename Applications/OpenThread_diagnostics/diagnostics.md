...
sort: 2
---
# run 802.15.4 diagnostics (aka mfglib)

The following text is a copy from [the openThread github](https://github.com/openthread/openthread/blob/main/src/core/diags/README.md) for your convenience.
